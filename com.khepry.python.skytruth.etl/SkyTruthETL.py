...
def main():
    ...
    rprtFileExpanded = os.path.join(trgtFldrPathExpanded, "rprtFile.txt")
    if os.path.exists(rprtFileExpanded):
        os.remove(rprtFileExpanded)
    chemFileExpanded = os.path.join(trgtFldrPathExpanded, "chemFile.txt")
    if os.path.exists(chemFileExpanded):
        os.remove(chemFileExpanded)
    blndFileExpanded = os.path.join(trgtFldrPathExpanded, "blndFile.txt")
